...
export class ProfileController {
    ...
    async arithmetic(@Req() req: Request){
        ...
        if(req.body.operation_type == 'addition'){
            return { slackUsername: 'agwuekene41', result: req.body.x + req.body.y, operation_type : req.body.operation_type}
        }
        else if(req.body.operation_type == 'subtraction'){ result = req.body.x - req.body.y}
        else if(req.body.operation_type == 'multiplication'){ result = req.body.x * req.body.y}
